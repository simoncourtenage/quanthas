...
{-|
  ...
  Description: WesternCalendar Implementation data declaration
  Copyright: (c) Simon Courtenage 2017
  Maintainer: courtenage@gmail.com
-}

module QuantHas.Time.Calendar.WesternCalendarImpl
    (westernCalendarImpl
   , isWesternWeekend
   , getWesternEasterMonday
   , isWesternEaster
   , module QuantHas.Time.Calendar.CalendarImpl)
    where
...
westernCalendarImpl = CalImpl isWesternEaster getWesternEasterMonday isWesternWeekend westernEasterMondays

-- | Is the given day in the year an Easter Monday according to the Western Calendar?
isWesternEaster :: Int -> Year -> Bool
isWesternEaster = checkIsEasterMonday westernCalendarImpl

-- | get easter monday from western calendar 
getWesternEasterMonday :: Year -> Int
getWesternEasterMonday = lookupEasterMonday westernCalendarImpl
...
westernEasterMondays
    = convEasterMondays westernEasterMondaysLst